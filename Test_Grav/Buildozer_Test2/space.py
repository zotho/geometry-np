...
class Space(EffectWidget):
    ...
    def collide(self, p1, p2, t):
        ...
        self.tails.append([deque(p1.tail_coords), p1.tail_back, len(p1.tail_coords) + p1.tail_back, p1.round_size()])
        self.tails.append([deque(p2.tail_coords), p2.tail_back, len(p2.tail_coords) + p2.tail_back, p2.round_size()])
        p3 = Planet(pos=pos,
                    vel=vel,
                    acc=acc,
                    mass=mass,
